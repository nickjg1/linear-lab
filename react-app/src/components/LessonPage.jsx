		...
		<div className="article">
			...
			<div className="articleBody">
				...
				<p>
					...
					concept of the arrow vector. Let’s imagine an{' '}
					<strong>arrow vector</strong> sitting on a Cartesian plane—or{' '}
					<strong>X-Y plane</strong>
				...
				<h3>Question 1</h3>
				<p>
					Input an algebraic vector so that it matches the green arrow vector
					given.
				</p>
				<embed
